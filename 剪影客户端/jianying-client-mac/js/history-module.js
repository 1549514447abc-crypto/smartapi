            ...
            historyPage.innerHTML = `
                ...
                <div class="bento-grid">
                    <section class="bento-card bento-card--4 bento-card--mint">
                        ...
                        <div style="margin-top: 12px;" class="toolbar-row">
                            <label for="historyFilter" class="toolbar-label">筛选：</label>
                            <select id="historyFilter" class="form-control form-control--compact">
